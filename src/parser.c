...
enum {
  ...
  sym_expression_id = 29,
  sym_expression_parentheses = 30,
  sym_expression_this = 31,
  sym_expression_name = 32,
  sym_string = 33,
  sym__char = 34,
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_binary, 3, .production_id = 4),
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_binary, 3, .production_id = 4),
  ...
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 2),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_unary, 2, .production_id = 1),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_unary, 2, .production_id = 1),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [45] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_this, 2),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_this, 2),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_name, 2),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_name, 2),
  [57] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [59] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_count, 2, .production_id = 2),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_count, 2, .production_id = 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_parentheses, 3),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_parentheses, 3),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_id, 3, .production_id = 3),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_id, 3, .production_id = 3),
